	...
	<div id="pagebody">
		...
		<div id="center">
			<table>
				...
				?>
				<input type="hidden" value="<?php echo	$bookId['id']/* ⑰ ⑯の戻り値からidを取り出し、設定する */;?>" name="books[]">
				<tr>
					<td><?php echo	/* ⑱ ⑯の戻り値からidを取り出し、表示する */$bookId['id'];?></td>
					<td><?php echo	/* ⑲ ⑯の戻り値からtitleを取り出し、表示する */$bookId['title'];?></td>
					<td><?php echo	/* ⑳ ⑯の戻り値からauthorを取り出し、表示する */$bookId['author'];?></td>
